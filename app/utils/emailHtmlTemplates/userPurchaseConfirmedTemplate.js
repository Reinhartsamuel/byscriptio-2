export default function userPurchaseConfirmedTemplate(props) {
  ...
  <div class="main">
    <div class="container">
      <p>
        ...
        <br />
          Congratulations!. We have confirmed your payment.
      </p>
      <br />
      <ul>
      ...
      <br />
      <p>You can use byScript autotraders by going to <a href='https://byscript.io/'>byScript dashboard here</a>. Contact  WA <a href="https://wa.me/6281313383848">here</a> for more info.</p>
      <br />
      <br />
      <p>Receipt:</p>
      <img
