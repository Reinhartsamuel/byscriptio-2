...
const Tooltip = ({ children, text, className }) => {
    return (
        <div className={cn("relative inline-block group", className)}>
            ...
            <div className="absolute bottom-full mb-2 w-32 p-2 text-sm text-white bg-gray-600 rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                {text}
