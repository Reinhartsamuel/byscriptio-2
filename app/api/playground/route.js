...
export async function GET() {
  try {
    const doc = await adminDb
      .collection('dca_bots')
      .doc('GvvxXjnZbhgYpUFuLvKo')
      .get();
    const autotraderData = { ...doc.data(), id: doc.id };

    await adminDb
      .collection('3commas_logs')
      .doc('oB6GF5Y1bE2kqQoDDnMg')
      .update({
        exchange_thumbnail: autotraderData.exchange_thumbnail
      })
...
//       return {...responseCloseMarket,smart_trade_id};
//     }
