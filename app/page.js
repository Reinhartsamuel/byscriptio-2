  ...
  return (<>
    ...
    <section className="relative flex flex-col items-center justify-center md:h-screen bg-cover bg-center pt-20 md:pt-24" style={{ backgroundImage: `url(${herobackground.src})` }}>
      ...
      <div className="w-full md:max-w-6xl px-6 py-12 mx-auto space-y-8 md:space-y-0 md:grid md:grid-cols-3 md:gap-3">
        <div className="p-[2px] bg-gradient-to-r from-white to-green-400 rounded-lg">
          <div className="flex flex-col items-center justify-center p-6 space-y-2 bg-black rounded-lg">
...
const FAQ = () => {
  ...
  const faqData = [
    {
      question: "Are my funds safe with byScript.io?",
      answer: "Absolutely. Your funds remain in your personal exchange account. byScript.io only connects via secure API and never has direct access to withdraw or move your funds. We prioritize security above all else."
    },
    {
      question: "Do I need coding experience?",
      answer: "Not at all. byScript.io is designed to be user-friendly for everyone. You can choose from our ready-made strategies or customize existing ones through our intuitive interface without writing a single line of code."
    },
    {
      question: "Which exchanges are supported?",
      answer: "We currently support major exchanges including Binance and Indodax, with more being added regularly. Our platform integrates seamlessly with 3Commas for reliable execution."
    },
    {
      question: "How do I get started?",
      answer: "Getting started is simple. Create an account, connect your exchange via API, select a strategy, and activate automation. Our step-by-step guide will walk you through the entire process, and our support team is always available to help."
    }
  ];
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-transparent to-gray-800">
      <div className="max-w-4xl mx-auto px-6">
        {/* Section Header */}
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Frequently <span className="text-brand_primary">Asked</span> Questions
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Get answers to the most common questions about byScript.io.
          </p>
        </div>
          ...
          {faqData.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full px-8 py-6 text-left flex justify-between items-center hover:bg-gray-800 transition-colors duration-200"
              >
